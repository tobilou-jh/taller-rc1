...
int main()
{
    ...
    do
    {
        ...
        case 3:
            ...
            printf("Ingrese el nuevo tiempo de producción por unidad: ");
            *pTiempoProduccion = validarDecimalPositivo();
        ...
        case 6:
            ...
            float tiempoDisp = validarDecimalPositivo();

            float tiempoNecesario = demanda * pTiemposProduccion[idx];
